      ...
      <div className="flex flex-col items-center gap-y-12">
        ...
        <div className="flex justify-between w-3/4 items-center gap-x-32">
          <p className="text-lg font-light text-gray-500 text-justify leading-8">
            ...
            غذا، وضعیت سلامت طیور، و تغییرات محیطی، این داده‌ها تبدیل به منابع
            ارزشمندی می‌شوند.
            <br />
            <br />
            ...
            مصنوعی مانند یادگیری ماشین برای پیش‌بینی نیازهای طیور در شرایط مختلف
            استفاده می‌شود. این تحلیل دقیق به مدیران مرغداری امکان می‌دهد تا
            تصمیمات هوشمندانه‌تری در زمینه‌هایی مانند تنظیمات تغذیه، بهینه‌سازی
            مصرف انرژی، و پیشگیری از بیماری‌ها اتخاذ کنند، که در نهایت به بهبود
            بهره‌وری و سلامتی طیور منجر خواهد شد.
          </p>
          <Image
