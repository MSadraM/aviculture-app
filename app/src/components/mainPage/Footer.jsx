...
export default function Footer() {
  return (
    <footer className="flex justify-center bg-emerald-200 py-4 text-emerald-900 font-medium mb-0 w-full hover:bg-emerald-900 hover:text-emerald-200 duration-300 mt-8">
      کلیه حقوق مادی و معنوی این سایت متعلق به طیورتک است
    </footer>
